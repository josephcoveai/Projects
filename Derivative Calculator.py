# -*- coding: utf-8 -*-
"""
Created on Wed Dec  2 15:00:43 2020

@author: Joseph Cove

Symbolic differentiation of prefix expressions

This code calculates derivatives in prefix notation by calling the diff() function
...
Examples
5(x+3) -> diff('(* (+ x 3) 5)') returns 5
5cos(x^2) -> diff('(* 5 (cos (^ x 2)))') returns (* 5 (* (* 2 x) (* -1 (sin (^ x 2))))) -> -10sin(x^2)
"""
